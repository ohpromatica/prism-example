      ...
      <div className="flex flex-row">
        <div>
          <div className="p-1 m-1 border-t-8 border-gray-300 bg-slate-50">
            <h4 className="my-2 text-sm text-gray-500">
              Frailty and number of co-morbidities with Diabetes
            </h4>
            <table className="border border-gray-500">
              <thead>
                <tr>
                  <th className="p-1 border-l border-gray-500">
                    Comorbidities
                  </th>
          ...
          <div className="p-1 m-1 border-t-8 border-gray-300 bg-slate-50">
            <h4 className="my-2 text-sm text-gray-500">
              Housebound or in care home
            </h4>
            106 (6.8%)
          </div>
        </div>
        <div className="p-1 m-6 border-t-8 border-gray-300 bg-slate-50 w-[700px]">
