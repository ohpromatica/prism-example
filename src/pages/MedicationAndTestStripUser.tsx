...
function MedicationAndTestStripUser() {
  return (
    <div>
      Medication and Test Strip use
      <div className="flex flex-row">
        <div className="w-[700px] p-1 m-2 text-gray-500 border-t-8 border-gray-300 bg-slate-50">
          Medication split
          <Bar options={medicationOptions} data={medicationData} />
        </div>
        <div className="w-[500px] p-1 m-2 text-gray-500 border-t-8 border-gray-300 bg-slate-50">
          BGTS and Flash use
